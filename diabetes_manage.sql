...
MySQL - 5.5.28 : Database - diabetes_manage
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`diabetes_manage` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `app_token`(`id`,`token`,`user_id`,`duration`,`role_type`,`create_d`,`update_d`,`delete_d`) values (4,'594dd5b0d03cd774d590a0537d3eeb0b',4,86400,0,'2015-12-13 22:00:34','2015-12-29 16:49:09',NULL),(6,'2390aa6be291f4853be387710a57c7d1',2,86400,1,'2015-12-16 16:52:31','2015-12-29 16:56:04',NULL);

/*Table structure for table `blood_sugar_log` */
...
/*Data for the table `blood_sugar_log` */

insert  into `blood_sugar_log`(`id`,`sufferer_id`,`sugar_content`,`create_d`,`update_d`,`delete_d`) values (6,4,2.00,'2015-12-13 22:48:51',NULL,NULL),(7,4,8.00,'2015-12-14 11:23:38',NULL,NULL),(8,4,12.00,'2015-12-15 18:32:39',NULL,NULL),(9,4,5.00,'2015-12-16 14:45:37',NULL,NULL),(10,4,2.00,'2015-12-25 15:41:59',NULL,NULL);
...
insert  into `doctor`(`id`,`name`,`phone`,`password`,`sex`,`birthday`,`address`,`hospital`,`photo`,`certificate_image`,`is_activate`,`create_d`,`update_d`,`delete_d`,`post`,`info`) values (2,'aaa','13837113789','5d93ceb70e2bf5daa84ec3d0cd2c731a',-1,'1900-01-01',NULL,'henan','photoImage/1451372059152','/wbRl-fxhcvsf1122568.JPG',0,'2015-12-16 16:52:31','2015-12-29 14:54:19',NULL,'yuanzhang','sdfasdfasdfasdfasdf');
...
insert  into `opinion`(`id`,`phone`,`content`,`create_d`,`update_d`,`delete_d`) values (1,'13837113789','很不错啊','2015-12-15 23:01:33',NULL,NULL);
...
/*Data for the table `question_and_answer` */

insert  into `question_and_answer`(`id`,`question_id`,`answer_id`,`create_d`,`update_d`,`delete_d`) values (20,27,NULL,'2015-12-15 22:30:55',NULL,NULL),(21,28,NULL,'2015-12-15 22:31:34',NULL,NULL),(22,29,NULL,'2015-12-15 23:22:24',NULL,NULL);
...
insert  into `questions`(`id`,`title`,`content`,`sufferer_id`,`create_d`,`update_d`,`delete_d`) values (27,'aaaaaa','aaaaaaa',4,'2015-12-15 22:30:55',NULL,NULL),(28,'safsda','adfasdf',4,'2015-12-15 22:31:34',NULL,NULL),(29,'qqqq','qqqqqq',4,'2015-12-15 23:22:24',NULL,NULL);
...
CREATE TABLE `sufferer` (
  ...
  `birthday` date DEFAULT '1900-01-01',
  `address` varchar(100) DEFAULT NULL,
  `suffered_date` date DEFAULT '1900-01-01',
  `photo` varchar(50) DEFAULT NULL,
...
/*Data for the table `sufferer` */

insert  into `sufferer`(`id`,`name`,`phone`,`sex`,`birthday`,`address`,`suffered_date`,`photo`,`password`,`create_d`,`update_d`,`delete_d`) values (4,'萌萌阳','13837113789',0,'2014-11-17',NULL,'2015-12-04','photoImage/1450248465871','5d93ceb70e2bf5daa84ec3d0cd2c731a','2015-12-13 22:00:34','2015-12-16 14:48:00',NULL);
